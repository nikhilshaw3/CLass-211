...
def receiveMessage():
    ...
    while True:
        ...
        try:
            ...
            elif(chunk.decode()=="access_granted"):
                labelchat.configure(text = "")
                textarea.insert(END,"\n" + chunk.decode('ascii'))
                textarea.see("end")
            
            elif(chunk.decode() == "Oops!!! {client_name} decline your request..."):
                labelchat.configure(text = "")
                textarea.insert(END,"\n" + chunk.decode('ascii'))
                textarea.see("end")
...
def browseFiles():
    ...
    try:
        ...
        if(message[:4] == "send"):
            ...
            file_size = getFileSize("shared files/" + sending_file)
...
def sendMessage():
    ...
    if(msgtosend == "y" or msgtosend == "Y"):
        ...
        print("FILE SUCCESSFULL DOWNLOADED TO PATH" + download_path)
